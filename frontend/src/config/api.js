...
export const api = {
  ...
  projectDetails: () => apiFetch('/api/projects/details'),
  ...
  assignProjectManager: (id, data) => apiFetch(`/api/projects/${id}/assign-manager`, { method: 'POST', body: JSON.stringify(data) }),
  projectMembers:       (id) => apiFetch(`/api/projects/${id}/members`),
