...
export default function App() {
  ...
  return (
    <div className={`min-h-screen font-sans transition-colors duration-200 ${lightMode ? 'bg-[#FFFFFF] text-[#091E42]' : 'bg-[#07132B] text-[#F4F5F7]'}`}>
        ...
        <div className="w-full px-4 sm:px-8 lg:px-12 flex items-center justify-between py-0 h-14">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            <motion.button
              ...
              className="btn-jira-blue px-5 py-2 rounded text-sm font-bold shadow-sm"
            >
              Get it free
            </motion.button>

            {/* Search Icon */}
            <button aria-label="Search" className="text-slate-400 hover:text-[#0052CC] transition-colors">
            ...
            <button
              onClick={() => setIsLoginModalOpen(true)}
              className="text-sm font-bold hover:text-[#0052CC] transition-colors"
            >
              Sign In
            </button>
          </div>
      ...
      {/* 2. Wide Hero Section (Day Theme Default) */}
      <section className="pt-16 pb-24 px-6 sm:px-12 lg:px-16 w-full max-w-[1650px] mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl xl:text-7xl font-extrabold tracking-tight leading-tight">
              Move fast, stay aligned, <br />
              and build better - together
            </h1>
            <p className={`text-xl sm:text-2xl font-medium ${lightMode ? 'text-[#42526E]' : 'text-[#B3D4FF]'}`}>
            ...
            <div className="pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => setIsLoginModalOpen(true)}
                className="btn-jira-gold px-8 py-4 rounded text-lg font-bold shadow-xl"
              >
                Get it free
              </motion.button>
            </div>
            ...
            <div className={`p-8 rounded-3xl relative overflow-hidden shadow-xl border ${
              ...
              <div className="flex items-center justify-between pb-4 mb-6 border-b border-[#DFE1E6] dark:border-[#1E2D4A]">
                ...
                <div className="text-xs text-slate-400 font-mono flex items-center space-x-1">
                  <Move className="w-3.5 h-3.5 text-[#0052CC]" />
              ...
              <div className="space-y-3 text-xs font-mono">
                {[
                  ...
                  { key: 'ETL-168 Quick booking for accommodations...', status: 'TO DO', color: 'bg-[#42526E]' },
                  { key: 'ETL-169 Options & Payment Engine', status: 'TO DO', color: 'bg-[#42526E]' }
                ].map((item, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    ...
                    <span className={`px-2.5 py-1 rounded text-[10px] ${item.color} text-white font-bold tracking-wider`}>
                      {item.status}
                    </span>
                  </motion.div>
                ))}
      ...
      <section id="single-source" className="py-20 px-6 sm:px-12 lg:px-16 w-full max-w-[1650px] mx-auto text-center">
        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-10">
          ...
          {pillTabs.map((p) => {
            ...
            return (
              <button
                ...
                className={`relative px-8 py-3 rounded-full font-bold text-base sm:text-lg transition-all ${
                  isActive
        ...
        <div className="grid lg:grid-cols-12 gap-10 text-left items-center">
          
          <div className="lg:col-span-4 space-y-6">
            <h3 className="text-4xl sm:text-5xl font-extrabold tracking-tight">Plan</h3>
            <p className={`text-lg leading-relaxed ${lightMode ? 'text-[#42526E]' : 'text-[#B3D4FF]'}`}>
              Break the big ideas down into manageable chunks across teams with user stories, issues, and tasks.
            </p>

            <motion.div
              whileHover={{ y: -4 }}
              className="bg-[#0052CC] text-white p-8 rounded-3xl shadow-xl space-y-4 relative"
            >
              <div className="text-5xl font-serif text-sky-200">“</div>
              <p className="text-base font-semibold leading-relaxed">
                Work becomes a lot more visible when it's all in one place. It makes collaboration a whole lot easier.
              </p>
              <div className="pt-3 border-t border-blue-400/40 text-xs font-bold tracking-wider uppercase">
          ...
          <div className="lg:col-span-8">
            <div className={`p-8 rounded-3xl border ${lightMode ? 'bg-[#FAFBFC] border-[#DFE1E6]' : 'bg-[#0B1B3D] border-[#1E2D4A]'}`}>
              <div className="flex items-center justify-between pb-4 mb-6 border-b border-[#DFE1E6] dark:border-[#1E2D4A]">
                <div className="flex items-center space-x-3 text-sm font-bold">
                  <span className="text-[#0052CC]">Beyond Gravity Project</span>
                  <span className="text-slate-400">/ Board</span>
                </div>
                <button className="px-4 py-1.5 bg-[#0052CC] text-white rounded-lg text-xs font-bold shadow-sm">Create</button>
              </div>
      ...
      {/* 4. Wide BKlit.ui Data Visuals & Charts Section */}
      <section id="bklit-charts" className="py-20 px-6 sm:px-12 lg:px-16 w-full max-w-[1650px] mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-[#0052CC]/10 text-[#0052CC] text-xs font-mono font-bold mb-4">
        ...
        <div className={`p-8 sm:p-12 rounded-3xl border shadow-xl ${lightMode ? 'bg-[#FAFBFC] border-[#DFE1E6]' : 'bg-[#0B1B3D] border-[#1E2D4A]'}`}>
          <div className="flex flex-col sm:flex-row items-center justify-between pb-8 mb-8 border-b border-[#DFE1E6] dark:border-[#1E2D4A] gap-4">
            <div>
              <h3 className="text-2xl font-bold">Sprint Velocity vs Budget Allocation</h3>
              <p className={`text-sm mt-1 ${lightMode ? 'text-[#5E6C84]' : 'text-slate-400'}`}>Live telemetry across 6 active enterprise sprints</p>
            </div>
          ...
          <div className="h-64 flex items-end justify-between gap-6 px-6 pt-4 border-b border-[#DFE1E6] dark:border-[#1E2D4A] pb-4">
            {chartData.map((d, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-3 group">
                <div className="w-full flex items-end justify-center gap-2 h-48">
                  <motion.div
                    ...
                    className="w-1/2 bg-[#36B37E] rounded-t-lg hover:bg-emerald-400 transition-colors relative"
                  >
                    <span className="opacity-0 group-hover:opacity-100 absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-xs px-2 py-0.5 rounded font-mono">
                      {d.velocity}%
                    </span>
                  </motion.div>
                  <motion.div
                    ...
                    className="w-1/2 bg-[#0052CC] rounded-t-lg hover:bg-blue-400 transition-colors relative"
                  >
                    <span className="opacity-0 group-hover:opacity-100 absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-xs px-2 py-0.5 rounded font-mono">
                      ${d.budget}k
                    </span>
                ...
                <span className={`text-xs font-mono font-bold ${lightMode ? 'text-[#5E6C84]' : 'text-slate-400'}`}>{d.label}</span>
              </div>
            ))}
          </div>

          <div className="flex justify-center items-center space-x-8 mt-6 text-sm font-mono font-bold">
            <span className="flex items-center space-x-2">
              <span className="w-3.5 h-3.5 bg-[#36B37E] rounded" />
              <span>Sprint Velocity Index</span>
            </span>
            <span className="flex items-center space-x-2">
              <span className="w-3.5 h-3.5 bg-[#0052CC] rounded" />
      ...
      {/* 5. Wide Kokonut.ui Bento Suite */}
      <section id="kokonut-bento" className="py-20 px-6 sm:px-12 lg:px-16 w-full max-w-[1650px] mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-[#36B37E]/10 text-[#36B37E] text-xs font-mono font-bold mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className={`p-8 rounded-3xl border flex flex-col justify-between cursor-pointer ${
                lightMode ? 'bg-[#FAFBFC] border-[#DFE1E6] hover:border-[#0052CC]' : 'bg-[#0B1B3D] border-[#1E2D4A]'
              }`}
            >
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#0052CC]/10 text-[#0052CC] flex items-center justify-center mb-6">
                  <c.icon className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold mb-3">{c.title}</h3>
                <p className={`text-sm leading-relaxed mb-6 ${lightMode ? 'text-[#42526E]' : 'text-[#B3D4FF]'}`}>{c.desc}</p>
              </div>
              <div className="text-xs font-mono text-[#0052CC] dark:text-cyan-400 bg-slate-100 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-200 dark:border-slate-800 font-bold">
                {c.tables}
              </div>
            </motion.div>
          ))}
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-16 w-full max-w-[1650px] mx-auto text-center">
        ...
        <p className={`text-lg max-w-4xl mx-auto leading-relaxed mb-16 ${lightMode ? 'text-[#42526E]' : 'text-[#B3D4FF]'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-16 text-center text-xs">
          {[
            ...
            <div key={idx} className={`p-6 rounded-2xl border flex flex-col justify-between ${
              ...
              <div className="w-12 h-12 rounded-full bg-[#0052CC] text-white font-bold flex items-center justify-center mx-auto mb-4 text-xs">
                {n.tag}
              </div>
        ...
        <button
          onClick={() => setIsLoginModalOpen(true)}
          className="btn-jira-gold px-10 py-4 rounded-xl text-lg font-bold shadow-xl inline-block"
        >
          Get it free
        </button>
      </section>
