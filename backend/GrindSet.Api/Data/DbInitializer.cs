...
namespace GrindSet.Api.Data
{
    public static class DbInitializer
    {
        ...
        {
            // =========================================================================
            // 🏢 1. ACME GLOBAL TECHNOLOGIES (CompanyId: 2) - Expansion
            // =========================================================================
            var acmeOwner = EnsureUser(context, "corp@acmeglobal.com", "Company");
            ...
            // Base Acme employees
            var acmeEmp1User = EnsureUser(context, "john.dev@grindset.io", "Employee");
            ...
            var acmeEmp2User = EnsureUser(context, "sarah.pm@grindset.io", "Employee");
            ...
            // Additional Acme workforce (total 8 employees, within Free limit of 10)
            var acmeEmp3User = EnsureUser(context, "david.miller@acmeglobal.com", "Employee");
            ...
            var acmeEmp4User = EnsureUser(context, "emma.watson@acmeglobal.com", "Employee");
            ...
            var acmeEmp5User = EnsureUser(context, "robert.vance@acmeglobal.com", "Employee");
            ...
            var acmeEmp6User = EnsureUser(context, "priya.sharma@acmeglobal.com", "Employee");
            ...
            var acmeEmp7User = EnsureUser(context, "carlos.mendez@acmeglobal.com", "Employee");
            ...
            var acmeEmp8User = EnsureUser(context, "liam.oconnor@acmeglobal.com", "Employee");
            ...
            // =========================================================================
            var apexOwner = EnsureUser(context, "elena.vance@apexcyber.io", "Company");
            ...
            var apexEmp1User = EnsureUser(context, "marcus.brody@apexcyber.io", "Employee");
            ...
            var apexEmp2User = EnsureUser(context, "natalie.rivera@apexcyber.io", "Employee");
            ...
            var apexEmp3User = EnsureUser(context, "zack.vance@apexcyber.io", "Employee");
            ...
            var apexEmp4User = EnsureUser(context, "aisha.mansoor@apexcyber.io", "Employee");
            ...
            var apexEmp5User = EnsureUser(context, "viktor.reznov@apexcyber.io", "Employee");
            ...
            var apexEmp6User = EnsureUser(context, "chloe.dupont@apexcyber.io", "Employee");
            ...
            var apexEmp7User = EnsureUser(context, "lucas.takahashi@apexcyber.io", "Employee");
            ...
            var apexEmp8User = EnsureUser(context, "maya.lin@apexcyber.io", "Employee");
            ...
            var apexEmp9User = EnsureUser(context, "ethan.hunt@apexcyber.io", "Employee");
            ...
            var apexEmp10User = EnsureUser(context, "sofia.rossi@apexcyber.io", "Employee");
            ...
            var apexEmp11User = EnsureUser(context, "gabriel.santos@apexcyber.io", "Employee");
            ...
            var apexEmp12User = EnsureUser(context, "hannah.abbott@apexcyber.io", "Employee");
            ...
            // =========================================================================
            var bioOwner = EnsureUser(context, "marcus.thorne@biovance.com", "Company");
            ...
            var bioEmp1User = EnsureUser(context, "evelyn.reed@biovance.com", "Employee");
            ...
            var bioEmp2User = EnsureUser(context, "alex.hayes@biovance.com", "Employee");
            ...
            var bioEmp3User = EnsureUser(context, "beatrice.sterling@biovance.com", "Employee");
            ...
            var bioEmp4User = EnsureUser(context, "daniel.kim@biovance.com", "Employee");
            ...
            var bioEmp5User = EnsureUser(context, "olivia.zhang@biovance.com", "Employee");
            ...
            var bioEmp6User = EnsureUser(context, "julian.frost@biovance.com", "Employee");
            ...
            var bioEmp7User = EnsureUser(context, "samantha.cruz@biovance.com", "Employee");
            ...
            var bioEmp8User = EnsureUser(context, "thomas.becker@biovance.com", "Employee");
            ...
            var bioEmp9User = EnsureUser(context, "clara.oswald@biovance.com", "Employee");
            ...
            var bioEmp10User = EnsureUser(context, "neil.armstrong@biovance.com", "Employee");
            ...
            // BioVance Projects (3 projects, within Pro limit of 5)
            ...
            // =========================================================================
            var hypOwner = EnsureUser(context, "david.chen@hyperionlogistics.com", "Company");
            ...
            var hypEmp1User = EnsureUser(context, "raj.patel@hyperionlogistics.com", "Employee");
            ...
            var hypEmp2User = EnsureUser(context, "megan.fox@hyperionlogistics.com", "Employee");
            ...
            var hypEmp3User = EnsureUser(context, "arthur.pendelton@hyperionlogistics.com", "Employee");
            ...
            var hypEmp4User = EnsureUser(context, "grace.hopper@hyperionlogistics.com", "Employee");
            ...
            var hypEmp5User = EnsureUser(context, "kenji.sato@hyperionlogistics.com", "Employee");
            ...
            var hypEmp6User = EnsureUser(context, "laura.croft@hyperionlogistics.com", "Employee");
            ...
            var hypEmp7User = EnsureUser(context, "brandon.lee@hyperionlogistics.com", "Employee");
            ...
            var hypEmp8User = EnsureUser(context, "teresa.may@hyperionlogistics.com", "Employee");
            ...
            var hypEmp9User = EnsureUser(context, "ian.malcolm@hyperionlogistics.com", "Employee");
            ...
            // Hyperion Projects (3 projects, within Pro limit of 5)
            ...
            // =========================================================================
            var kryOwner = EnsureUser(context, "alyssa.monroe@kryptonfin.io", "Company");
            ...
            var kryEmp1User = EnsureUser(context, "henrik.lindqvist@kryptonfin.io", "Employee");
            ...
            var kryEmp2User = EnsureUser(context, "sophia.kowalski@kryptonfin.io", "Employee");
            ...
            var kryEmp3User = EnsureUser(context, "devraj.mukherjee@kryptonfin.io", "Employee");
            ...
            var kryEmp4User = EnsureUser(context, "isabelle.dubois@kryptonfin.io", "Employee");
            ...
            var kryEmp5User = EnsureUser(context, "tyler.durden@kryptonfin.io", "Employee");
            ...
            var kryEmp6User = EnsureUser(context, "zoe.kravitz@kryptonfin.io", "Employee");
            ...
            var kryEmp7User = EnsureUser(context, "omar.farooq@kryptonfin.io", "Employee");
            ...
            var kryEmp8User = EnsureUser(context, "natalie.portman@kryptonfin.io", "Employee");
            ...
            var kryEmp9User = EnsureUser(context, "felix.kjellberg@kryptonfin.io", "Employee");
            ...
            var kryEmp10User = EnsureUser(context, "amber.heard@kryptonfin.io", "Employee");
            ...
            var kryEmp11User = EnsureUser(context, "christopher.nolan@kryptonfin.io", "Employee");
            ...
            var kryEmp12User = EnsureUser(context, "wendy.rhoades@kryptonfin.io", "Employee");
            ...
            var kryEmp13User = EnsureUser(context, "bobby.axelrod@kryptonfin.io", "Employee");
            ...
            var kryEmp14User = EnsureUser(context, "taylor.mason@kryptonfin.io", "Employee");
            ...
            // =========================================================================
            var norOwner = EnsureUser(context, "astrid.lind@nordicclean.energy", "Company");
            ...
            var norEmp1User = EnsureUser(context, "soren.kirkegaard@nordicclean.energy", "Employee");
            ...
            var norEmp2User = EnsureUser(context, "freja.nygard@nordicclean.energy", "Employee");
            ...
            var norEmp3User = EnsureUser(context, "lars.ulrich@nordicclean.energy", "Employee");
            ...
            var norEmp4User = EnsureUser(context, "greta.thunberg@nordicclean.energy", "Employee");
            ...
            var norEmp5User = EnsureUser(context, "erik.thorvald@nordicclean.energy", "Employee");
            ...
            // Nordic Project (1 project, exactly Free tier limit)
            ...
            // =========================================================================
            var nexOwner = EnsureUser(context, "kai.sterling@nexusmedia.studio", "Company");
            ...
            var nexEmp1User = EnsureUser(context, "maya.hawke@nexusmedia.studio", "Employee");
            ...
            var nexEmp2User = EnsureUser(context, "sean.murray@nexusmedia.studio", "Employee");
            ...
            var nexEmp3User = EnsureUser(context, "billie.eilish@nexusmedia.studio", "Employee");
            ...
            var nexEmp4User = EnsureUser(context, "hideo.kojima@nexusmedia.studio", "Employee");
            ...
            // Nexus Project (1 project, exactly Free tier limit)
            ...
            // =========================================================================
            var vngOwner = EnsureUser(context, "vikram.patel@vanguardrobotics.com", "Company");
            ...
            var vngEmp1User = EnsureUser(context, "hiroshi.sato@vanguardrobotics.com", "Employee");
            ...
            var vngEmp2User = EnsureUser(context, "emily.blunt@vanguardrobotics.com", "Employee");
            ...
            var vngEmp3User = EnsureUser(context, "tony.stark@vanguardrobotics.com", "Employee");
            ...
            var vngEmp4User = EnsureUser(context, "bruce.banner@vanguardrobotics.com", "Employee");
            ...
            var vngEmp5User = EnsureUser(context, "natasha.romanoff@vanguardrobotics.com", "Employee");
            ...
            var vngEmp6User = EnsureUser(context, "peter.parker@vanguardrobotics.com", "Employee");
            ...
            var vngEmp7User = EnsureUser(context, "wanda.maximoff@vanguardrobotics.com", "Employee");
            ...
            var vngEmp8User = EnsureUser(context, "vision@vanguardrobotics.com", "Employee");
            ...
            var vngEmp9User = EnsureUser(context, "sam.wilson@vanguardrobotics.com", "Employee");
            ...
            var vngEmp10User = EnsureUser(context, "bucky.barnes@vanguardrobotics.com", "Employee");
            ...
            var vngEmp11User = EnsureUser(context, "james.rhodes@vanguardrobotics.com", "Employee");
        ...
        private static User EnsureUser(GrindSetDbContext context, string email, string role, string approvalStatus = "Approved")
        {
        ...
        {
            var existing = context.Projects.FirstOrDefault(p => p.CompanyId == companyId && p.ProjectName == name);
            if (existing != null) return existing;
        ...
        {
            var existing = context.Transactions.FirstOrDefault(t => t.AccountId == accountId && t.Type == type && t.Amount == amount);
            if (existing != null) return;
